...
public class MainActivity extends AppCompatActivity {
    ...
    public void dialPhoneNumpber(String phoneNumber) {
    ...
    public void composeSmsMassage(String message) {
